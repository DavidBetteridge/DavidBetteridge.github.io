...
I've got over 25 years of experience as a professional software developer.  During that time I've used a number of different programming languages and technologies.  
Previously I was using the Microsoft Stack (C#, F#, SQL Server, Windows and .net Core).  

My current area of expertise is on Python, React.js, AWS and Postgres.
